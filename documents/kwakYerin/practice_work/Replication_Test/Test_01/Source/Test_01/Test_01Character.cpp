...
void ATest_01Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATest_01Character::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ATest_01Character::Look);
	...
	{
		UE_LOG(LogTest_01, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}

void ATest_01Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATest_01Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATest_01Character::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ATest_01Character::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ATest_01Character::DoJumpEnd()
{
